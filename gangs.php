...
<br>
<center>
<h2 size="100" style="text-align: center;"><span style="color: #33cccc;">Gangs List</span></h1></center>
...
<div class="table-responsive">
		...
		<table class="table" cellspacing="100">
						<thead>
<tr>
                          <th><font color="#FF0000">Gang ID</font></th>
							<th><font color="#0000FF">Gang Tag</font></th>
														<th><font color="#FF4500">Gang Name</font></th>

							<th><font color="Black">Gang Founder</font></th>
                                     <th><font color="Blue">Gang Score</font></th>
 ...
 <tr>				
		<?php
						$query = $koneksi->prepare("SELECT gID, gName, gTag, gFounder, gScore , gColor FROM `groups`");
						$query->execute();
						
						if($query->rowCount() == 0)
						{
							echo "<tr><td colspan='6'><small>There's no Gangs created in Server</small></td></tr>";
						}
						while($data = $query->fetch())
						{
							if($data['gColor'] == 0)
							{
						$data['gColor'] = "Permanent";
							}
							echo "<tr><td>".$data['gID']."</td>";
							echo "<td>".$data['gTag']."</td>";
														echo "<td>".$data['gName']."</td>";
							echo "<td>".$data['gFounder']."</td>";
echo "<td>".$data['gScore']."</tr></td>";
